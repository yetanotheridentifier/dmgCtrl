...
│   ├── useXwingGame      (hook — playerScore, opponentScore, round, gameOver, gameEnded, result; endGame() for explicit game-end; reset(initialPlayer, initialOpponent) for deficit-based starts; restoreState for undo)
