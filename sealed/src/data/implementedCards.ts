...
export const IMPLEMENTED_LEADERS: LeaderStatus[] = [
  ...
  // The other sealed sets
  { id: 'SOR_014', name: 'Sabine Wren', front: true, back: true },
  { id: 'IBH_53', name: 'Darth Vader', front: true, back: true },
  { id: 'IBH_1', name: 'Leia Organa', front: true, back: true },
  { id: 'SOR_010', name: 'Darth Vader', front: true, back: true },
  { id: 'SOR_005', name: 'Luke Skywalker', front: true, back: true },
  { id: 'JTL_007', name: 'Admiral Holdo', front: true, back: true },
  { id: 'JTL_004', name: 'Rose Tico', front: true, back: true },
  { id: 'TWI_015', name: 'General Grievous', front: true, back: true },
  { id: 'TWI_006', name: 'Wat Tambor', front: true, back: true },
  { id: 'TWI_003', name: 'Obi-Wan Kenobi', front: true, back: true },
  { id: 'SEC_015', name: 'C-3PO', front: true, back: true },
  { id: 'SOR_011', name: 'Grand Inquisitor', front: true, back: true },
  { id: 'SHD_003', name: 'Finn', front: true, back: true },
  { id: 'SHD_012', name: 'Bo-Katan Kryze', front: true, back: true },
  { id: 'JTL_010', name: 'Captain Phasma', front: true, back: true },
  { id: 'LOF_011', name: 'Kit Fisto', front: true, back: true },
  { id: 'LAW_005', name: 'Jyn Erso', front: true, back: true },
  { id: 'SOR_002', name: 'Iden Versio', front: true, back: true },
  { id: 'SHD_011', name: 'Kylo Ren', front: true, back: true },
...
export const IMPLEMENTED_EVENTS: UpgradeStatus[] = [
  ...
  { id: 'SOR_187', name: 'I Had No Choice' },
  { id: 'SHD_077', name: 'Evidence of the Crime' },
  { id: 'JTL_232', name: 'Jump to Lightspeed' },
  { id: 'TWI_089', name: 'Consolidation of Power' },
  { id: 'LOF_220', name: 'Shien Flurry' },
  { id: 'LOF_043', name: 'The Tragedy of Plagueis' },
...
export const IMPLEMENTED_UNITS: UpgradeStatus[] = [
  ...
  // Activated "Action:" abilities
  { id: 'LOF_134', name: 'Heavy Missile Gunship' },
  { id: 'IBH_16', name: 'Ion Cannon' },
  { id: 'SHD_196', name: 'Grogu' },
  { id: 'TWI_206', name: 'Independent Senator' },
  { id: 'TWI_056', name: 'Compassionate Senator' },
  { id: 'TWI_157', name: 'Disaffected Senator' },
  { id: 'IBH_62', name: 'Imperial Deck Officer' },
  { id: 'SHD_087', name: 'Crosshair' },
  { id: 'SEC_216', name: 'Regulations Bureaucrat' },
  { id: 'JTL_146', name: 'Massassi Tactical Officer' },
  { id: 'TWI_105', name: 'Steadfast Senator' },
  { id: 'IBH_23', name: 'General Rieekan' },
  { id: 'TWI_082', name: 'MagnaGuard Wing Leader' },
  { id: 'SOR_110', name: 'Frontline Shuttle' },
  { id: 'LOF_243', name: 'Caretaker Matron' },
  { id: 'JTL_134', name: 'General Hux' },
  { id: 'SEC_093', name: 'C-3P0' },
  { id: 'LAW_084', name: 'Krrsantan' },
  { id: 'SHD_028', name: 'Doctor Pershing' },
  { id: 'TWI_194', name: 'Ahsoka Tano' },
  { id: 'SOR_093', name: 'Alliance Dispatcher' },
  { id: 'SOR_129', name: 'Admiral Ozzel' },
  { id: 'LOF_246', name: 'Grogu' },
  { id: 'SHD_256', name: 'Mercenary Gunship' },
  { id: 'LAW_174', name: '0-0-0' },
  { id: 'LAW_184', name: 'Aerie' },
  { id: 'LAW_173', name: 'BT-1' },
  { id: 'LAW_051', name: 'Beilert Valance' },
  { id: 'LAW_057', name: 'Benthic "Two Tubes"' },
  { id: 'LAW_104', name: 'Bodhi Rook' },
  { id: 'LAW_031', name: 'Bossk' },
  { id: 'LAW_192', name: 'Bracca Shipbreaker' },
  { id: 'LAW_228', name: 'Canyon Frontrunner' },
  { id: 'LAW_048', name: 'Chio Fain' },
  { id: 'LAW_181', name: 'Cloud-Rider Veteran' },
  { id: 'LAW_062', name: 'Defiant Hammerhead' },
  { id: 'LAW_194', name: 'Doctor Aphra' },
  { id: 'LAW_095', name: 'Finn' },
  { id: 'LAW_216', name: "Jabba's Rancor" },
  { id: 'LAW_087', name: 'Jango Fett' },
  { id: 'LAW_079', name: 'K-2S0' },
  { id: 'LAW_068', name: 'Millennium Falcon' },
  { id: 'LAW_197', name: 'Shifty Suspects' },
  { id: 'LAW_107', name: 'Swoop Bike Marauder' },
  { id: 'LAW_163', name: 'The Sarlacc of Carkoon' },
  { id: 'LAW_182', name: 'Weazel' },
  { id: 'LAW_064', name: 'Zuckuss' },
  { id: 'SEC_204', name: 'Blue Ace' },
  { id: 'SEC_218', name: 'Cikatro Vizago' },
  { id: 'SEC_162', name: 'Crosshair' },
  { id: 'SEC_188', name: 'Darth Traya' },
  { id: 'SEC_137', name: 'Dryden Vos' },
  { id: 'SEC_197', name: 'Furtive Handmaiden' },
  { id: 'SEC_110', name: 'GNK Power Droid' },
  { id: 'SEC_220', name: 'Hired Slicer' },
  { id: 'SEC_208', name: 'Hunter' },
  { id: 'SEC_185', name: 'Screeching TIE Fighter' },
  { id: 'SEC_045', name: 'Senator Chuchi' },
  { id: 'SEC_225', name: 'Synara San' },
  { id: 'LOF_106', name: 'Acclamator Assault Ship' },
  { id: 'LOF_170', name: 'Bendu' },
  { id: 'LOF_144', name: 'Jedi Starfighter' },
  { id: 'LOF_068', name: 'Luthen Rael' },
  { id: 'LOF_250', name: 'Medical Frigate' },
  { id: 'LOF_160', name: 'Merrin' },
  { id: 'LOF_163', name: 'Quinlan Vos' },
  { id: 'LOF_135', name: 'Scythe' },
  { id: 'LOF_184', name: 'Second Sister' },
  { id: 'LOF_045', name: 'Yaddle' },
  { id: 'LOF_204', name: 'Zuckuss' },
  { id: 'JTL_037', name: 'Banshee' },
  { id: 'JTL_147', name: 'Black One' },
  { id: 'JTL_168', name: 'Insurgent Saboteurs' },
  { id: 'JTL_151', name: 'Red Five' },
  { id: 'JTL_157', name: 'Relentless Firespray' },
  { id: 'JTL_238', name: 'Sith Trooper' },
  { id: 'JTL_160', name: 'Supporting Eta-2' },
  { id: 'TWI_034', name: 'General Grievous' },
  { id: 'TWI_202', name: 'Jar Jar Binks' },
  { id: 'TWI_085', name: 'Kalani' },
  { id: 'TWI_154', name: 'Mister Bones' },
  { id: 'TWI_035', name: 'Morgan Elsbeth' },
  { id: 'TWI_195', name: 'Sabine Wren' },
  { id: 'TWI_150', name: 'Saw Gerrera' },
  { id: 'TWI_179', name: 'Soulless One' },
  { id: 'TWI_063', name: 'Vulture Interceptor Wing' },
  { id: 'SHD_199', name: 'Coruscant Dissident' },
  { id: 'SHD_220', name: 'Fennec Shand' },
  { id: 'SHD_048', name: 'Gentle Giant' },
  { id: 'SHD_246', name: 'Grey Squadron Y-Wing' },
  { id: 'SHD_118', name: 'Kihrazx Heavy Fighter' },
  { id: 'SHD_183', name: 'Kintan Intimidator' },
  { id: 'SHD_150', name: 'Koska Reeves' },
  { id: 'SHD_041', name: 'Kuiil' },
  { id: 'SHD_046', name: 'Rey' },
  { id: 'SHD_151', name: 'Valiant Assault Ship' },
  { id: 'SOR_059', name: '2-1B Surgical Droid' },
  { id: 'SOR_156', name: 'Benthic "Two Tubes"' },
  { id: 'SOR_179', name: 'Boba Fett' },
  { id: 'SOR_185', name: 'Chimaera' },
  { id: 'SOR_188', name: 'Chopper' },
  { id: 'SOR_131', name: 'Fifth Brother' },
  { id: 'SOR_158', name: 'Jedha Agitator' },
  { id: 'SOR_047', name: 'Kanan Jarrus' },
  { id: 'SOR_206', name: 'Mining Guild TIE Fighter' },
  { id: 'SOR_208', name: 'Outer Rim Headhunter' },
  { id: 'SOR_067', name: 'Rugged Survivors' },
  { id: 'SOR_142', name: 'Sabine Wren' },
  { id: 'SOR_244', name: 'Snowspeeder' },
  { id: 'SOR_116', name: 'Steadfast Battalion' },
  { id: 'TS26_75', name: 'Jango Fett' },
  { id: 'TS26_66', name: 'Wartime Pirate' },
  { id: 'TS26_43', name: 'Wartime Refugee' },
  { id: 'TS26_29', name: 'Ziton Moj' },
  { id: 'IBH_60', name: 'Admiral Piett' },
  { id: 'IBH_10', name: 'Han Solo' },
  { id: 'IBH_11', name: 'R2-D2' },
  { id: 'IBH_6', name: 'Rebellion Y-Wing' },
  // When Defeated
  { id: 'LAW_189', name: 'Cavern Angels X-Wing' },
  { id: 'TWI_131', name: 'OOM-Series Officer' },
  { id: 'LAW_097', name: 'Imperial Door Technician' },
  { id: 'IBH_15', name: 'Tauntaun Mount' },
  { id: 'JTL_033', name: 'Onyx Squadron Brute' },
  { id: 'LOF_059', name: 'Nightsister Warrior' },
  { id: 'JTL_063', name: 'Landing Shuttle' },
  { id: 'SHD_164', name: 'Rhokai Gunship' },
  { id: 'SEC_263', name: 'Assassin Probe' },
  { id: 'LOF_235', name: 'HK-87 Assassin Droid' },
  { id: 'SEC_154', name: 'Inner Rim Coalition' },
  { id: 'SOR_226', name: 'Admiral Motti' },
  { id: 'SEC_221', name: 'Unruly Astromech' },
  { id: 'SOR_060', name: 'Distant Patroller' },
  { id: 'LOF_064', name: 'Tauntaun' },
  { id: 'JTL_060', name: 'Desperate Commando' },
  { id: 'TWI_104', name: 'Obedient Vanguard' },
  { id: 'JTL_040', name: 'Fleet Interdictor' },
  { id: 'JTL_220', name: 'Skyway Cloud Car' },
  { id: 'TWI_148', name: 'Senatorial Corvette' },
  { id: 'IBH_82', name: 'Admiral Ozzel' },
  { id: 'SOR_163', name: 'Star Wing Scout' },
  { id: 'LOF_057', name: 'Owen Lars' },
