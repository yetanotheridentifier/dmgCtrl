...
export const IMPLEMENTED_UNITS: UpgradeStatus[] = [
  ...
  { id: 'HMW_077', name: 'Boss Nass' },
  { id: 'HMW_144', name: 'Howler Pack' },
  { id: 'HMW_244', name: 'Separatist Harbinger' },
  { id: 'TWI_229', name: 'Battle Droid Escort' },
  { id: 'JTL_087', name: 'TIE Ambush Squadron' },
  { id: 'JTL_090', name: 'Executor' },
  { id: 'JTL_117', name: 'General Draven' },
  { id: 'TS26_14', name: 'Yoda' },
  { id: 'TWI_181', name: 'Elite P-38 Starfighter' },
  { id: 'SEC_142', name: 'Fulminatrix' },
  { id: 'SEC_171', name: 'Punishing One' },
  { id: 'LAW_214', name: 'Boba Fett' },
  { id: 'TWI_048', name: "Obi-Wan's Aethersprite" },
  { id: 'SOR_134', name: 'Ruthless Raider' },
  { id: 'TWI_046', name: 'Captain Typho' },
  { id: 'SEC_031', name: 'Nute Gunray' },
  { id: 'LOF_165', name: 'Asajj Ventress' },
  { id: 'JTL_088', name: 'Captain Phasma' },
  { id: 'SEC_202', name: 'Rebel Propagandist' },
  { id: 'SEC_119', name: 'Crucible' },
  { id: 'SOR_050', name: 'The Ghost' },
  { id: 'SOR_160', name: 'Wolffe' },
